...
/**
 * The main function to initialize and render the cryptocurrency data table.
 *
 * This asynchronous function performs the following actions:
 * 1. Fetches the top 100 cryptocurrencies sorted by market capitalization in
 *    descending order.
 * 2. Dynamically adds 10 rows to the table for displaying the coin data.
 * 3. Renders the data for the first page.
 * 4. Adds event listeners to handle user interactions with the pagination buttons and
 *    sort dropdown menu.
 */
async function main() {
